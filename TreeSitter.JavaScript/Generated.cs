...
namespace TreeSitter.JavaScript.Nodes {
    ...
    public class ClassBody : JavaScriptLanguageNode
    {
        ...
        public System.Collections.Generic.List<GlimmerTemplate> Template { get; set; }
        public ClassBody(TreeSitter.Node node) : base(node)
        {
            ...
            this.Template = node.ChildrenByFieldName("template").Select(x => new GlimmerTemplate(x)).ToList();
        }
    }
    ...
    public class ClassStaticBlock : JavaScriptLanguageNode
    {
        public StatementBlock Body { get; set; }
    ...
    {
        public JavaScriptLanguageNode? Alias { get; set; }
        ...
        public ExportSpecifier(TreeSitter.Node node) : base(node)
        {
            ...
            
            {
                ...
                this.Alias = tmp is null ? null : (JavaScriptLanguageNode) JavaScriptLanguageNode.FromNode(tmp);
            }
    ...
    public class GlimmerClosingTag : JavaScriptLanguageNode
    {
    ...
    public class GlimmerOpeningTag : JavaScriptLanguageNode
    {
    ...
    public class GlimmerTemplate : JavaScriptLanguageNode, Expression
    {
    ...
    public class JsxClosingElement : JavaScriptLanguageNode
    {
        ...
        public JsxClosingElement(TreeSitter.Node node) : base(node)
        {
            ...
            {
                var tmp = node.ChildByFieldName("name");
                this.Name = tmp is null ? null : (JavaScriptLanguageNode) JavaScriptLanguageNode.FromNode(tmp);
            }
        }
    }
    ...
    public class MemberExpression : JavaScriptLanguageNode, Pattern, PrimaryExpression
    {
        ...
        public MemberExpression(TreeSitter.Node node) : base(node)
        {
            ...
            
            {
                ...
                this.Object = tmp is null ? null : (Expression) JavaScriptLanguageNode.FromNode(tmp);
            }
            {
                var tmp = node.ChildByFieldName("optional_chain");
                this.OptionalChain = tmp is null ? null : new OptionalChain(tmp);
            }
            {
                ...
                this.Property = tmp is null ? null : (JavaScriptLanguageNode) JavaScriptLanguageNode.FromNode(tmp);
            }
            this.Children = node.NamedChildrenWithFields
                .Where(x => x.Key == null && !x.Value.IsExtra)
                .Select(x => x.Value)
    ...
    public class OptionalChain : JavaScriptLanguageNode
    {
